    ...
    <section className="py-20 px-4 bg-muted/40">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          <p className="text-xs tracking-[0.4em] text-muted-foreground uppercase mb-4 font-sans">Selected Works</p>
          <h2 className="font-serif text-4xl md:text-5xl font-light mb-4">Featured Works</h2>
        </div>
          ...
          <Card className="overflow-hidden shadow-2xl" style={{ width: 1068, height: 520, maxWidth: '100%' }}>
            <div className="grid md:grid-cols-2 gap-0 h-full">
              ...
              <CardContent className="p-8 flex flex-col justify-center h-full overflow-hidden">
                <Badge className="w-fit mb-4 bg-secondary text-secondary-foreground font-sans text-xs tracking-widest uppercase">
                  {currentWork.series}
                </Badge>

                <h3 className="font-serif text-3xl font-light mb-4 truncate" title={currentWork.title}>{currentWork.title}</h3>
